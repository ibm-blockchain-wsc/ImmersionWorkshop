...
**3.** Once that has ran its course, click on the three dots (``...``) and select ``Start Fabric Runtime``. This will start up a new local Fabric that we will use in the next part of the lab. 
